...
| 05 | Dynamic Programming 2 | 동적계획법 2 | [바로가기](./dynamic_programming_2) | 25 | 75 | ![status][Doing] |
...
1. 코드 리팩토링
2. Contributors 추가 스크립트화
3. 문제 뽑으면 Discussions 또는 Issue에서 바로 간단한 명령어로 추가 기능(스크립트화)
4. 문제 추가 방식 변경
